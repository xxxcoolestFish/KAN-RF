"""Efficient Stage 54 formula-graph PPO experiment."""
...
from kanrf.formula_graph_operator_fast import ProtoKANFormulaOperatorFast
...
class FormulaGraphActorFast(base.GaussianActorBase):
    def __init__(self, cognitive: base.ContextCognitiveKAN,
                 hidden_dim: int = 64):
        super().__init__(hidden_dim)
        self.cognitive = cognitive
        self.formula = ProtoKANFormulaOperatorFast(
            cognitive.network, basis_count=8, token_dim=FORMULA_TOKEN_DIM,
        )
        self.query = base._mlp(
            base.ACTOR_STATE_DIM + base.STATE_DIM, hidden_dim, FORMULA_TOKEN_DIM,
        )
        ...
        self.decision_head = base._mlp(
            hidden_dim + FORMULA_TOKEN_DIM, hidden_dim, base.ACTION_DIM,
        )
...
base.ContextFiLMActor = FormulaGraphActorFast
